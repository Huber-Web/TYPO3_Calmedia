 ...
 ***************************************************************/
  ...
  * WeekCal Controller
  */
class WeekCalController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	/**
	 * dateRepository
	 * 
	...
	public function listAction(\PfarreNg\Calmedia\Domain\Model\Typ $cat = null) {
		if($cat){
			$this->view->assign('dates', $this->dateRepository->listWeek($cat));
			$this->view->assign('cat', $cat);
		}else{
			$this->view->assign('dates', $this->dateRepository->listWeek());
		}
