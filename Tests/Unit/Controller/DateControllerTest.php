...
/**
 * Test case for class PfarreNg\Calmedia\Controller\DateController.
 *
...
class DateControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \PfarreNg\Calmedia\Controller\DateController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('PfarreNg\\Calmedia\\Controller\\DateController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
